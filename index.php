...
$report_d = '';
$report_q = $dbs->query('SELECT title,loan_date,biblio_id AS total_loans FROM `loan_history` WHERE member_id IS NOT NULL AND biblio_id IS NOT NULL
...
HTML;
  ...
  $report_d .= '</ol>';
    ...
    $report_d = '<i>'.__('There are no Popular Titles in this period').'</i>';
}
$collection_stat[__('10 Most Popular Titles')] = $report_d;
